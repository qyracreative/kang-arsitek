        ...
        <div className="p-4 mx-4 rounded-xl border border-red-500/10 bg-red-500/5 space-y-4 animate-in fade-in zoom-in duration-500">
          ...
          <div className="space-y-2">
            <p className="text-[9px] text-zinc-500 font-bold uppercase leading-relaxed">
              Google Sheets sync is blocked. This usually happens when the script is not deployed as a <span className="text-zinc-300">"Web App"</span> or <span className="text-zinc-300">"Who has access"</span> is not set to <span className="text-zinc-300">"Anyone"</span>.
            </p>
            <div className="p-2 bg-zinc-950/50 rounded border border-zinc-800/50">
              <p className="text-[8px] text-zinc-600 font-mono leading-tight">
                Fix: Deploy {"->"} New Deployment {"->"} Anyone. See browser console for detailed steps.
              </p>
            </div>
          </div>
          <button 
